...
void
Shizu_Test_BigInteger_testFromString
  (
    Shizu_State2* state
  )
{
  ...
  // Integer32.Maximum
  x = Shizu_BigInteger_createFromString(state, Shizu_String_create(state, "2147483647", strlen("2147483647")));
  received = (Shizu_Value)Shizu_Value_InitializerObject(Shizu_BigInteger_toString(state, x));
  ...
  // Integer64.Minimum
  x = Shizu_BigInteger_createFromString(state, Shizu_String_create(state, "-9223372036854775808", strlen("-9223372036854775808")));
  received = (Shizu_Value)Shizu_Value_InitializerObject(Shizu_BigInteger_toString(state, x));
  ...
  // Integer64.Maximum
  x = Shizu_BigInteger_createFromString(state, Shizu_String_create(state, "9223372036854775807", strlen("9223372036854775807")));
  received = (Shizu_Value)Shizu_Value_InitializerObject(Shizu_BigInteger_toString(state, x));
