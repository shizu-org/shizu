...
void
Shizu_Test_BigInteger10_testToInteger32
  (
    Shizu_State2* state
  )
{
  ...
  received = (Shizu_Value)Shizu_Value_InitializerInteger32(Shizu_BigInteger10_toInteger32(state, x));
...
void
Shizu_Test_BigInteger10_testToInteger64
  (
    Shizu_State2* state
  )
{
  ...
  x = Shizu_BigInteger10_createFromInteger64(state, INT64_C(0));
  received = (Shizu_Value)Shizu_Value_InitializerInteger64(Shizu_BigInteger10_toInteger64(state, x));
  ...
  x = Shizu_BigInteger10_createFromInteger64(state, Shizu_Integer64_Minimum);
  received = (Shizu_Value)Shizu_Value_InitializerInteger64(Shizu_BigInteger10_toInteger64(state, x));
  ...
  x = Shizu_BigInteger10_createFromInteger64(state, Shizu_Integer64_Maximum);
  received = (Shizu_Value)Shizu_Value_InitializerInteger64(Shizu_BigInteger10_toInteger64(state, x));
