  ...
  )
{
  ...
  if (!setjmp(jumpTarget.environment)) {
    ...
    //
    parse(state, Shizu_String_concatenate(state, path, Shizu_String_create(state, "strings.ddl", strlen("strings.ddl"))));
    //
    parse(state, Shizu_String_concatenate(state, path, Shizu_String_create(state, "integers.ddl", strlen("integers.ddl"))));
    //
    parse(state, Shizu_String_concatenate(state, path, Shizu_String_create(state, "empty-list.ddl", strlen("empty-list.ddl"))));
    //
    parse(state, Shizu_String_concatenate(state, path, Shizu_String_create(state, "empty-map.ddl", strlen("empty-map.ddl"))));
