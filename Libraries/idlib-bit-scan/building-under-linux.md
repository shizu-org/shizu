...
An out of source build is the recommended way of building *IdLib Bit Scan*.

- Checkout `idlib-bit-scan` [https://github.com/michaelheilmann/idlib-bit-scan.git](https://github.com/michaelheilmann/idlib-bit-scan.git) into a directory in your file system.
...
The above builds *IdLib Bit Scan* without debug information. To build *IdLib Bit Scan* with debug information add the parameter `-DCMAKE_BUILD_TYPE="Debug"` to the cmake command.
