...
#if !defined(SHIZU_OBJECTS_ENVIRONMENT_PRIVATE_H_INCLUDED)
#define SHIZU_OBJECTS_ENVIRONMENT_PRIVATE_H_INCLUDED
...
#endif // SHIZU_OBJECTS_ENVIRONMENT_PRIVATE_H_INCLUDED
