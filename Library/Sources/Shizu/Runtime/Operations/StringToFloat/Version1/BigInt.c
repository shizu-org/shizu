...
#define TEST(X, Y, MAGNITUDE, SIGN) \
  ...
  TEST(INT64_MIN, 0, "9223372036854775808", -1);
  TEST(0, 0, "0", 0);
  ...
  TEST(+1998691, +9999991, "11998682", 1);
  TEST(+9999991, +1998691, "11998682", 1);

  TEST(+1998691, -9999991, "8001300", -1);
  TEST(-9999991, +1998691, "8001300", -1);
